...
**Phiên bản mới: 1.1-R08 (Canvas / Folia Region Thread-Safety Fix & Triumph-GUI Integration)**

Sao chép khối văn bản bên dưới để gửi thẳng lên kênh thông báo cập nhật của Discord:

```markdown
**DevLog Plugins #134 28 / 7 / 2026**
• **SolarElo-1.1-R08 (Canvas / Folia Region Thread-Safety Fix & Triumph-GUI Integration)**
...
> * Tích hợp thư viện GUI hiện đại **Triumph-GUI** (`dev.triumphteam:triumph-gui:3.1.10`) cùng thư viện bộ nhớ đệm **Caffeine** (`caffeine:3.1.8`) với cấu hình relocation tự động.
