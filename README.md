...
* Added dynamic Rank Difference Scaling mechanism (`rank-difference-scaling`): lower rank defeating higher rank receives scaled Elo bonus, while higher rank defeating lower rank receives scaled Elo penalty #1.1-R08
